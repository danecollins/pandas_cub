...
class DataFrame:
    ...
    def __init__(self, values):
        ...
        self._column_info = {k: v.dtype.kind for k, v in self._values.items()}
        # code here
    ...
    def __len__(self):
        ...
        return len(self._values[next(iter(self._values))])
    ...
    def columns(self, columns):
        ...
        new_values = {new_key: self._values[old_key] for new_key, old_key in zip(columns, self._values.keys())}
        new_column_info = {k: v.dtype.kind for k, v in new_values.items()}
